...
def draw_ball():
    cvs.delete("BALL")
    cvs.create_oval(ball_x-20,ball_y-20,ball_x+20,ball_x+20,fill="gold",outline="orange",width=2,tag="BALL")
    cvs.create_oval(ball_x-16,ball_y-16,ball_x+12,ball_x+12,fill="yellow",width=0,tag="BALL")

def move_ball():
    global idx,tmr,score,ball_x,
